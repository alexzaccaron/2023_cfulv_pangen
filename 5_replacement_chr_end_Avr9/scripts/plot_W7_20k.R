...
#fname_genes_chr7.bed   = "data/W7_chr7_20k_genes.bed" # args[2]
#fname_genes_chr2.bed   = "data/W7_chr2_20k_genes.bed" # args[2]

fname_repeats_chr7.gff   = "data/W7_chr7_20k_repeats.gff" # args[2]
fname_repeats_chr2.gff   = "data/W7_chr2_20k_repeats.gff" # args[2]
fname_nucmer = "output/01nucmer/W7_20k.delta1.coords"
...
pdf("plots/W7_20k.pdf", width = 4, height = 4.5)
...
# add copia element
segments(17993, 11.5, 13113, 11.5)
segments(15412, 4.5, 13079, 4.5)
